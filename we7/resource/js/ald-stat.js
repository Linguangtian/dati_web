...
!function() {
    var r = "6.1.2", i = "log", u = require("./ald-stat-conf.js"), o = 0, _ = 0, l = 0, d = 0;
    function c(t) {
        var a = "";
        try {
    ...
    var s = function() {
        this.aldstat_duration += Date.now() - this.aldstat_showtime, v(this, "app", "unLaunch");
    }, w = function(a, t, s) {
        ...
        if ((e || "launch" === s) && !(e < 1 && "number" == typeof e)) {
            ...
            "launch" === s ? _ += 1 : "show" === s ? l += 1 : d += 1, o.la_c = _, o.as_c = l, 
            o.ah_c = d, t.page_share_count && "number" == typeof t.page_share_count && (o.sc = t.page_share_count), 
        ...
        v(this, "app", "show"), void 0 !== t && (void 0 !== t.shareTicket ? w(this, t.shareTicket, "click") : void 0 !== t.query && void 0 !== t.query.ald_share_src && w(this, "0", "click"));
    }, S = function(t, a) {
        var s = this;
    ...
    var x = function(t, a) {
        ...
        if (void 0 !== t && void 0 !== t[1]) {
            ...
            return t[1].success = function(t) {
                new Array();
                if ("object" === _typeof(t.shareTickets)) for (var a = 0; a < t.shareTickets.length; a++) w(s, t.shareTickets[a], "user");
    ...
    App = function(t) {
        a(t, "onLaunch", e), a(t, "onUnlaunch", s), a(t, "onShow", y), a(t, "onHide", S), 
        a(t, "onError", n), I(t);
    };
    var E = Page;
    Page = function(t) {
        a(t, "onLoad", b), a(t, "onUnload", k), a(t, "onShow", D), a(t, "onHide", x), a(t, "onReachBottom", A), 
        a(t, "onPullDownRefresh", T), void 0 !== t.onShareAppMessage && function(t, s, e) {
            if (t[s]) {
                var n = t[s];
                t[s] = function(t) {
                    var a = n.call(this, t);
